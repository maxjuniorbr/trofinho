...
const rpcErrorMatchers = [
  ...
  ['Código inválido ou expirado', 'Código inválido ou expirado. Verifique o código e tente novamente.'],
  ['convite expirou', 'Este convite expirou. Solicite um novo código ao administrador.'],
