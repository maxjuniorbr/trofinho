...
import ChildBalanceAdminScreen from '../../app/(admin)/balances/[filho_id]';
...
const configureMutationMock = vi.hoisted(() => ({
  mutateAsync: vi.fn().mockResolvedValue(undefined),
  isPending: false,
}));

const configureRateMutationMock = vi.hoisted(() => ({
  mutateAsync: vi.fn().mockResolvedValue(undefined),
  isPending: false,
}));
...
vi.mock('@/hooks/queries', () => ({
  ...
  useConfigureAppreciation: () => configureMutationMock,
  useConfigureWithdrawalRate: () => configureRateMutationMock,
...
describe('ChildBalanceAdminScreen', () => {
  beforeEach(() => {
    ...
    configureMutationMock.mutateAsync.mockReset().mockResolvedValue(undefined);
    configureRateMutationMock.mutateAsync.mockReset().mockResolvedValue(undefined);
